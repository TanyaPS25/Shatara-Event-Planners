...
const ALL_YEARS: YearData[] = [
  {
    year: 2026,
    heroImage: "/images/themes/celestial_dream.png",
    ...
    months: [
      {
        ...
        events: [
          { title: "Winter Wonderland Gala", shortDate: "10 Jan", dateText: "10 January 2026", client: "Priya & Family", venue: "Taj Palace, New Delhi", theme: "Frozen Ivory & Silver", description: "An immersive winter celebration styled with custom ice sculptures, frosted glass panels, white floral runners, and cold spark arrays for a magical indoor forest feel hosting 400 elite guests.", tags: ["DECORATIONS", "LIGHTING", "ENTERTAINMENT"], image: "/images/themes/botanical_forest.png", thumb1: "/images/themes/sangeet_spectacle.png", thumb2: "/images/themes/royal_grandeur.png" },
          { title: "Strategic Partner Summit", shortDate: "24 Jan", dateText: "24 January 2026", client: "TechVest Ventures", venue: "The Oberoi, Mumbai", theme: "Platinum & Deep Teal", description: "An editorial corporate dinner designed with structural floral pillars, custom brass panels, and atmospheric uplighting tailored to the partner network of 200 delegates.", tags: ["CORPORATE", "PRODUCTION"], image: "/images/themes/wedding_hero.png", thumb1: "/images/stories/arjun_engagement.png", thumb2: "/images/stories/divya_reception.png" },
        ],
      },
      {
        ...
        events: [
          { title: "Secret Garden Soiree", shortDate: "14 Feb", dateText: "14 February 2026", client: "Rahul & Sneha", venue: "Private Villa, Alibaug", theme: "Pastel Rose & Sage", description: "An intimate botanical celebration featuring a canopy of 10,000 hanging pastel roses and sage foliage, customized lighting design, and a curated culinary experience for 80 guests.", tags: ["BOTANICAL", "CATERING", "STYLING"], image: "/images/stories/meena_babyshower.png", thumb1: "/images/stories/priya_birthday.png", thumb2: "/images/stories/rahul_anniversary.png" },
        ],
      },
      {
        ...
        events: [
          { title: "Shatara Grand Reception", shortDate: "15 Mar", dateText: "15 March 2026", client: "Divya M.", venue: "Le Meridien, Coimbatore", theme: "Royal Gold & White", description: "A luxurious wedding reception designed with elegant floral décor, bespoke lighting installations, and a refined ivory-and-gold color palette. We transformed the grand ballroom into a celestial garden space for over 500 elite guests.", tags: ["DECORATIONS", "CATERING"], image: "/images/themes/mehndi_magic.png", thumb1: "/images/themes/celestial_dream.png", thumb2: "/images/themes/modern_minimalist.png" },
          { title: "Spring Sakura Luncheon", shortDate: "22 Mar", dateText: "22 March 2026", client: "Meena S.", venue: "The Leela, Bangalore", theme: "Pastel Sage & Pink", description: "A delicate baby shower styled with cherry blossom installations, customized floral arches, and an artisanal confectionary station for high tea attended by 120 guests.", tags: ["FLORAL", "STYLING", "CONFECTIONARY"], image: "/images/themes/botanical_forest.png", thumb1: "/images/themes/sangeet_spectacle.png", thumb2: "/images/themes/royal_grandeur.png" },
          { title: "Editorial Jewelry Launch", shortDate: "29 Mar", dateText: "29 March 2026", client: "Zoya Atelier", venue: "Taj West End, Bangalore", theme: "Champagne Gold & Charcoal", description: "An ultra-premium brand launch styled as an art gallery exhibition, utilizing high contrast lighting and suspended glass display panels for 300 press and VIP attendees.", tags: ["PRODUCTION", "LIGHTING"], image: "/images/themes/wedding_hero.png", thumb1: "/images/stories/arjun_engagement.png", thumb2: "/images/stories/divya_reception.png" },
        ],
      },
      {
        ...
        image: "/images/stories/karthik_corporate.png",
        events: [
          { title: "Sunset Beach Mandap", shortDate: "05 Apr", dateText: "05 April 2026", client: "Ananya & Kabir", venue: "W Goa", theme: "Terracotta & Pampas Grass", description: "A stunning beachside wedding mandap constructed from local sandstones, dried pampas grass, and copper metallic frames, set against a sunset ocean backdrop for 350 guests.", tags: ["WEDDING", "BOTANICAL"], image: "/images/stories/meena_babyshower.png", thumb1: "/images/stories/priya_birthday.png", thumb2: "/images/stories/rahul_anniversary.png" },
          { title: "Celestial Anniversary Gala", shortDate: "12 Apr", dateText: "12 April 2026", client: "Asteria Tech Group", venue: "Ritz Carlton, Pune", theme: "Indigo & Burnished Brass", description: "An upscale celebration under a ceiling of fiber-optic star installations, complete with interactive light projections and symphonic orchestra.", tags: ["PRODUCTION", "LIGHTING"], image: "/images/themes/cocktail_glam.png", thumb1: "/images/themes/mehndi_magic.png", thumb2: "/images/themes/celestial_dream.png" },
          { title: "Spring Garden Reception", shortDate: "19 Apr", dateText: "19 April 2026", client: "Rohan & Riya", venue: "ITC Grand Chola, Chennai", theme: "White & Pastel Sage", description: "A grand reception featuring flower tunnels, custom stage design, and ambient warm lighting setup for 800 guests in lush garden atrium.", tags: ["WEDDING", "DECORATIONS"], image: "/images/themes/modern_minimalist.png", thumb1: "/images/themes/botanical_forest.png", thumb2: "/images/themes/sangeet_spectacle.png" },
          { title: "Modernist Rooftop Dinner", shortDate: "26 Apr", dateText: "26 April 2026", client: "Aditya & Kiara", venue: "Four Seasons, Mumbai", theme: "Silver & Glass", description: "A high-end intimate dinner under the stars featuring clear acrylic furniture, mirror tabletops, and minimal modern floral arrangements for 60 guests.", tags: ["STYLING", "CATERING"], image: "/images/themes/royal_grandeur.png", thumb1: "/images/themes/wedding_hero.png", thumb2: "/images/stories/arjun_engagement.png" },
        ],
      },
      {
      ...
      },
      {
        ...
        events: [
          { title: "Independence Day Gala", shortDate: "14 Aug", dateText: "14 August 2026", client: "National Pride Corp.", venue: "India Habitat Centre, Delhi", theme: "Tricolor & White", description: "A patriotic corporate gala featuring live cultural performances, a 3D light projection on the main facade, and a curated menu of regional cuisines for 500 attendees.", tags: ["CORPORATE", "CULTURAL"], image: "/images/themes/cocktail_glam.png", thumb1: "/images/themes/mehndi_magic.png", thumb2: "/images/themes/celestial_dream.png" },
          { title: "Moonlit Pool Reception", shortDate: "22 Aug", dateText: "22 August 2026", client: "Vikram & Isha", venue: "Amritara Private Luxury, Udaipur", theme: "Ivory & Moonlight Silver", description: "An ethereal poolside wedding reception with floating floral arrangements, mirrored tableaux, and a live string quartet performing under moonlight for 200 guests.", tags: ["WEDDING", "LUXURY"], image: "/images/themes/modern_minimalist.png", thumb1: "/images/themes/botanical_forest.png", thumb2: "/images/themes/sangeet_spectacle.png" },
          { title: "Children's Gala Fundraiser", shortDate: "30 Aug", dateText: "30 August 2026", client: "Little Stars NGO", venue: "Taj Vivanta, Kolkata", theme: "Rainbow & Pastel", description: "A vibrant fundraising gala featuring artisan craft workshops, storytelling theatre, balloon art installations, and a charity auction raising ₹45 lakhs.", tags: ["FUNDRAISER", "STYLING"], image: "/images/themes/royal_grandeur.png", thumb1: "/images/themes/wedding_hero.png", thumb2: "/images/stories/arjun_engagement.png" },
        ],
      },
      {
        ...
        image: "/images/stories/divya_reception.png",
        events: [
          { title: "Sarah's Birthday Celebration", shortDate: "12 Sep", dateText: "12 September 2026", client: "Sarah K.", venue: "The Grand Ballroom, Heritage Manor", theme: "Champagne & Blush Rose", description: "An exquisite birthday milestone celebration featuring custom floral ceiling installations, a signature perfume bar, bespoke cake artistry, and personalized gifting suites for 300 guests.", tags: ["BIRTHDAY", "LUXURY", "STYLING"], image: "/images/stories/karthik_corporate.png", thumb1: "/images/stories/meena_babyshower.png", thumb2: "/images/stories/priya_birthday.png" },
          { title: "Autumn Harvest Dinner", shortDate: "27 Sep", dateText: "27 September 2026", client: "Mehra Family", venue: "Siolim House, Goa", theme: "Autumn Rust & Copper", description: "A family harvest dinner inspired by European countryside aesthetics with copper chargers, dried hydrangea centrepieces, candlelit walkways, and a live jazz duo.", tags: ["PRIVATE DINING", "STYLING"], image: "/images/stories/rahul_anniversary.png", thumb1: "/images/themes/cocktail_glam.png", thumb2: "/images/themes/mehndi_magic.png" },
        ],
      },
      {
      ...
      },
      {
        ...
        events: [
          { title: "New Year's Eve Grand Ball", shortDate: "31 Dec", dateText: "31 December 2026", client: "Shatara Prestige Members", venue: "The Ritz-Carlton, Bangalore", theme: "Gold & Midnight Black", description: "Shatara's signature New Year celebration — a sold-out grand ball with a champagne tower, celebrity DJ performances, a gala dinner, and a fireworks finale welcoming 2027.", tags: ["GALA", "LUXURY", "ENTERTAINMENT"], image: "/images/stories/priya_birthday.png", thumb1: "/images/stories/rahul_anniversary.png", thumb2: "/images/themes/cocktail_glam.png" },
          { title: "Christmas Charity Dinner", shortDate: "24 Dec", dateText: "24 December 2026", client: "Hope Foundation", venue: "Hyatt Place, Pune", theme: "Crimson & Pine Green", description: "A charity dinner raising ₹60 lakhs for underprivileged children, styled with Nordic Christmas aesthetics, live choral performances, and an artisan gift market.", tags: ["CHARITY", "FESTIVE"], image: "/images/themes/mehndi_magic.png", thumb1: "/images/themes/celestial_dream.png", thumb2: "/images/themes/modern_minimalist.png" },
        ],
      },
    ],
  },
  {
    year: 2025,
    heroImage: "/images/themes/botanical_forest.png",
    tagline: "A year of refined elegance and curated memories.",
    months: [
      { slug: "jan", month: "January", abbr: "JAN", countLabel: "1 Event", image: "/images/themes/sangeet_spectacle.png", events: [{ title: "Luxury New Year Brunch", shortDate: "01 Jan", dateText: "01 January 2025", client: "Shatara Members", venue: "The Taj, Mumbai", theme: "Pearl White & Gold", description: "An exclusive New Year brunch celebrating 2025's arrival with champagne towers, artisan cheese stations, and live jazz for 150 members.", tags: ["LUXURY", "BRUNCH"], image: "/images/themes/royal_grandeur.png", thumb1: "/images/themes/wedding_hero.png", thumb2: "/images/stories/arjun_engagement.png" }] },
      { slug: "feb", month: "February", abbr: "FEB", countLabel: "2 Events", image: "/images/stories/divya_reception.png", events: [{ title: "Valentine's Luxury Dinner", shortDate: "14 Feb", dateText: "14 February 2025", client: "Private Clients", venue: "Leela Palace, Delhi", theme: "Rose Gold & Ivory", description: "An intimate Valentine's dining experience for 20 couples with private chef tables, floral tunnels, and customised keepsakes.", tags: ["LUXURY", "DINING"], image: "/images/stories/karthik_corporate.png", thumb1: "/images/stories/meena_babyshower.png", thumb2: "/images/stories/priya_birthday.png" }, { title: "Brand Launch Cocktail", shortDate: "28 Feb", dateText: "28 February 2025", client: "Arora Jewels", venue: "JW Marriott, Chandigarh", theme: "Blush & Champagne", description: "A jewellery brand cocktail launch with mirror display cubes, ambient DJ, and press photography for 300 guests.", tags: ["BRAND", "LAUNCH"], image: "/images/stories/rahul_anniversary.png", thumb1: "/images/themes/cocktail_glam.png", thumb2: "/images/themes/mehndi_magic.png" }] },
      { slug: "mar", month: "March", abbr: "MAR", countLabel: "2 Events", image: "/images/themes/celestial_dream.png", events: [{ title: "Spring Holi Carnival", shortDate: "15 Mar", dateText: "15 March 2025", client: "Mehta Clan", venue: "Private Farmhouse, Pune", theme: "Vibrant Multicolour", description: "A luxury Holi celebration with organic colour stations, a DJ arena, gourmet food trucks, and a fashion-forward dress code for 400 guests.", tags: ["FESTIVE", "CULTURAL"], image: "/images/themes/modern_minimalist.png", thumb1: "/images/themes/botanical_forest.png", thumb2: "/images/themes/sangeet_spectacle.png" }, { title: "Architecture Gala Awards", shortDate: "28 Mar", dateText: "28 March 2025", client: "IIA India Chapter", venue: "NCPA, Mumbai", theme: "Concrete & Gold", description: "An architectural excellence awards evening with minimalist brutalist decor, projection-mapped walls, and a gourmet sit-down dinner for 500.", tags: ["AWARDS", "CORPORATE"], image: "/images/themes/royal_grandeur.png", thumb1: "/images/themes/wedding_hero.png", thumb2: "/images/stories/arjun_engagement.png" }] },
      { slug: "apr", month: "April", abbr: "APR", countLabel: "1 Event", image: "/images/stories/divya_reception.png", events: [{ title: "Bougainvillea Wedding", shortDate: "19 Apr", dateText: "19 April 2025", client: "Sharma & Rao Families", venue: "Alila Fort Bishangarh, Rajasthan", theme: "Magenta & Cream", description: "A heritage fort wedding with bougainvillea-draped archways, hand-painted warli art, and classical Bharatanatyam performances for 700 guests.", tags: ["WEDDING", "HERITAGE"], image: "/images/stories/karthik_corporate.png", thumb1: "/images/stories/meena_babyshower.png", thumb2: "/images/stories/priya_birthday.png" }] },
      { slug: "may", month: "May", abbr: "MAY", countLabel: "0 Events", image: "/images/stories/rahul_anniversary.png", events: [] },
      { slug: "jun", month: "June", abbr: "JUN", countLabel: "1 Event", image: "/images/themes/cocktail_glam.png", events: [{ title: "Nuptials at Nizamuddin", shortDate: "21 Jun", dateText: "21 June 2025", client: "Ali & Fatima", venue: "Taj Mahal Hotel, Delhi", theme: "Teal & Silver", description: "A fusion Indo-Islamic wedding ceremony with a live Qawwali performance, geometric silver decorations, and a seven-course culinary journey for 400 guests.", tags: ["WEDDING", "FUSION"], image: "/images/themes/mehndi_magic.png", thumb1: "/images/themes/celestial_dream.png", thumb2: "/images/themes/modern_minimalist.png" }] },
      { slug: "jul", month: "July", abbr: "JUL", countLabel: "0 Events", image: "/images/themes/botanical_forest.png", events: [] },
      { slug: "aug", month: "August", abbr: "AUG", countLabel: "2 Events", image: "/images/themes/sangeet_spectacle.png", events: [{ title: "Independence Gala 2025", shortDate: "15 Aug", dateText: "15 August 2025", client: "MG Motors India", venue: "Jawahar Lal Nehru Stadium, Delhi", theme: "Saffron, White & Green", description: "A patriotic-themed product launch gala with a live drone light show, folk dance ensemble, and exclusive media preview for 1,500 guests.", tags: ["CORPORATE", "LAUNCH"], image: "/images/themes/royal_grandeur.png", thumb1: "/images/themes/wedding_hero.png", thumb2: "/images/stories/arjun_engagement.png" }, { title: "Desert Night Wedding", shortDate: "29 Aug", dateText: "29 August 2025", client: "Gupta & Dalmia", venue: "Serai Camp, Jaisalmer", theme: "Ochre & Star Silver", description: "A romantic desert wedding under a canopy of 3,000 lanterns, with a camel procession, traditional folk musicians, and fusion cuisine under the stars.", tags: ["WEDDING", "DESTINATION"], image: "/images/stories/divya_reception.png", thumb1: "/images/stories/karthik_corporate.png", thumb2: "/images/stories/meena_babyshower.png" }] },
      { slug: "sep", month: "September", abbr: "SEP", countLabel: "1 Event", image: "/images/stories/priya_birthday.png", events: [{ title: "Founders' Circle Retreat", shortDate: "20 Sep", dateText: "20 September 2025", client: "Nexus Ventures", venue: "COMO Shambhala, Bali", theme: "Tropical Ivory & Palm", description: "An exclusive international founders' retreat blending wellness programming, strategy sessions, and luxury hospitality across a three-day Balinese escape for 40 CEOs.", tags: ["CORPORATE", "RETREAT"], image: "/images/stories/rahul_anniversary.png", thumb1: "/images/themes/cocktail_glam.png", thumb2: "/images/themes/mehndi_magic.png" }] },
      { slug: "oct", month: "October", abbr: "OCT", countLabel: "3 Events", image: "/images/themes/celestial_dream.png", events: [{ title: "Navratri Grand Dandiya", shortDate: "05 Oct", dateText: "05 October 2025", client: "Patel Community Trust", venue: "GMDC Grounds, Ahmedabad", theme: "Vibrant Embroidery & Mirror", description: "Gujarat's most extravagant Navratri celebration with LED-lit garba arenas, 5,000 participants, and a live sitar-electronic fusion performance.", tags: ["CULTURAL", "FESTIVE"], image: "/images/themes/modern_minimalist.png", thumb1: "/images/themes/botanical_forest.png", thumb2: "/images/themes/sangeet_spectacle.png" }, { title: "Palace Wedding — Jaipur", shortDate: "18 Oct", dateText: "18 October 2025", client: "Poddar & Saraf Families", venue: "Rambagh Palace, Jaipur", theme: "Rajasthani Gold & Ruby", description: "A multi-day Rajasthani royal wedding with elephant processions, traditional ghoomar dance, and a palace fireworks finale for 800 guests.", tags: ["WEDDING", "ROYAL"], image: "/images/themes/royal_grandeur.png", thumb1: "/images/themes/wedding_hero.png", thumb2: "/images/stories/arjun_engagement.png" }, { title: "Diwali Corporate Celebration", shortDate: "29 Oct", dateText: "29 October 2025", client: "HDFC Securities", venue: "Sofitel, Mumbai BKC", theme: "Marigold & Deep Burgundy", description: "An elite corporate Diwali celebration featuring customised mithai gifting, a live comedy act, and a formal awards ceremony for 700 staff.", tags: ["CORPORATE", "FESTIVE"], image: "/images/stories/divya_reception.png", thumb1: "/images/stories/karthik_corporate.png", thumb2: "/images/stories/meena_babyshower.png" }] },
      { slug: "nov", month: "November", abbr: "NOV", countLabel: "2 Events", image: "/images/stories/priya_birthday.png", events: [{ title: "Anniversary Black Tie Gala", shortDate: "08 Nov", dateText: "08 November 2025", client: "Shatara Luxury Events", venue: "Conrad, Bangalore", theme: "Black Tie & Gold", description: "Shatara's annual stakeholder gala marking 13 years of luxury event excellence, featuring a champagne tower, live opera, and a curated retrospective display.", tags: ["GALA", "ANNIVERSARY"], image: "/images/stories/rahul_anniversary.png", thumb1: "/images/themes/cocktail_glam.png", thumb2: "/images/themes/mehndi_magic.png" }, { title: "Boutique Fashion Week After-Party", shortDate: "22 Nov", dateText: "22 November 2025", client: "FDCI", venue: "Qutub Club, Delhi", theme: "Celestial Black & Crystal", description: "An exclusive fashion week finale after-party featuring celebrity guests, a crystal-draped bar, and DJ Nucleya headlining for 500 guests.", tags: ["FASHION", "ENTERTAINMENT"], image: "/images/themes/celestial_dream.png", thumb1: "/images/themes/modern_minimalist.png", thumb2: "/images/themes/botanical_forest.png" }] },
      { slug: "dec", month: "December", abbr: "DEC", countLabel: "1 Event", image: "/images/themes/sangeet_spectacle.png", events: [{ title: "New Year Countdown Gala 2026", shortDate: "31 Dec", dateText: "31 December 2025", client: "Shatara Prestige Members", venue: "Taj Lands End, Mumbai", theme: "Champagne & Stardust", description: "The most anticipated event of 2025 — a black tie countdown gala with a 7-course dinner, celebrity DJ, champagne fountain, and fireworks over the Arabian Sea.", tags: ["GALA", "NYE"], image: "/images/themes/royal_grandeur.png", thumb1: "/images/themes/wedding_hero.png", thumb2: "/images/stories/arjun_engagement.png" }] },
    ],
  },
  {
    year: 2027,
    heroImage: "/images/stories/divya_reception.png",
    tagline: "The future of celebration — coming soon.",
    months: [
      { slug: "jan", month: "January", abbr: "JAN", countLabel: "Upcoming", image: "/images/stories/karthik_corporate.png", events: [{ title: "New Year Grand Kickoff", shortDate: "01 Jan", dateText: "01 January 2027", client: "Shatara Members", venue: "TBA — Exclusive Venue", theme: "Pristine White & Gold", description: "Kick off 2027 with Shatara's most ambitious celebration yet — a multi-city simultaneous gala planned across Mumbai, Delhi, and Bangalore for 2,000 members.", tags: ["GALA", "UPCOMING"], image: "/images/stories/meena_babyshower.png", thumb1: "/images/stories/priya_birthday.png", thumb2: "/images/stories/rahul_anniversary.png" }] },
      ...Array.from({ length: 11 }, (_, i) => {
        ...
        return { slug: abbrs[i].toLowerCase(), month: months[i], abbr: abbrs[i], countLabel: "Upcoming", image: imgs[i], events: [] };
      }),
    ],
  },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="mx-auto max-w-[1280px] px-[20px] lg:px-[80px] py-16 space-y-14">
            ...
            {ALL_YEARS.map(y => (
              ...
              >
                <div className="relative h-36 w-56">
                  <Image src={y.heroImage} alt={`${y.year}`} fill className="object-cover transition-all duration-700 group-hover:scale-110 group-hover:blur-[3px]" />
                  <div className={`absolute inset-0 transition-all duration-500 z-0 ${
                    selectedYear === y.year
                      ? 'bg-gradient-to-t from-black/70 via-black/20 to-transparent'
                      : 'bg-gradient-to-t from-black/75 via-black/40 to-black/10 group-hover:bg-black/60'
                  }`} />
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center gap-1 z-10">
                    <span className={`font-display text-4xl font-bold drop-shadow-lg transition-all duration-300 ${
                      selectedYear === y.year ? 'text-primary-container shatara-glow' : 'text-white group-hover:text-primary-container group-hover:scale-110'
                    }`}>{y.year}</span>
                    <span className="text-xs sm:text-sm font-bold tracking-widest text-white/90 group-hover:text-primary-container uppercase drop-shadow-md transition-all duration-300 group-hover:scale-110">
                ...
                >
                  ...
                  <div className="relative h-24 w-full">
                    <Image
                      ...
                      alt={m.month}
                      fill
                      className="object-cover transition-all duration-600 group-hover:scale-110 group-hover:blur-[2px]"
                    />
                    {/* Overlay */}
                    <div className={`absolute inset-0 transition-all duration-400 z-0 ${
                      isActive
                        ? 'bg-gradient-to-t from-black/60 via-black/20 to-transparent'
                        : 'bg-black/55 group-hover:bg-black/60'
                    }`} />
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center gap-1.5 z-10">
                      <span className={`text-xs md:text-sm font-extrabold tracking-widest transition-all duration-300 drop-shadow-md ${
                        isActive ? 'text-primary-container' : 'text-white group-hover:text-primary-container group-hover:scale-110'
                      }`}>{m.abbr}</span>
                      {m.events.length > 0 && (
                        <span className="bg-primary-container text-on-primary-container text-[10px] md:text-xs font-extrabold px-2 py-0.5 rounded-sm leading-none shadow-md transition-transform duration-300 group-hover:scale-110">
                          {m.events.length}
                        </span>
                      )}
                    </div>
                    {isActive && (
                      <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-primary-container shadow-[0_0_6px_rgba(200,155,60,0.8)] z-10" />
                    )}
                  </div>
                  {/* Label bar */}
                  <div className={`text-[9px] font-bold py-1.5 text-center tracking-wide transition-colors duration-300 ${
                    isActive
        ...
        <div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3">
            {yearData.months.flatMap(m => m.events.slice(0, 1)).slice(0, 12).map((ev, i) => (
              <div key={i} className="relative h-40 rounded-lg overflow-hidden border border-outline-variant/15 group cursor-pointer shadow-sm hover:shadow-md transition-shadow">
                <Image src={ev.thumb1} alt={ev.title} fill className="object-cover group-hover:scale-110 transition duration-700" />
                <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-black/10 group-hover:from-black/70 transition duration-500" />
                <div className="absolute bottom-0 left-0 right-0 p-3">
                  <p className="text-sm text-white font-semibold line-clamp-2 leading-snug drop-shadow-md">{ev.title}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="relative overflow-hidden rounded-lg text-center py-16 px-8">
          <Image src="/images/themes/cocktail_glam.png" alt="CTA Background" fill className="object-cover opacity-30" />
