    ...
    <div className="bg-[var(--page)] min-h-screen text-[var(--ink)] antialiased">
      <section className="relative h-[75vh] w-full flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl px-5 text-center text-white">
          ...
          <h1 className="mt-4 font-display text-4xl sm:text-6xl font-medium tracking-wide leading-tight">
            Curated Graduation Ceremonies
          </h1>
          <p className="mt-4 max-w-2xl mx-auto text-sm sm:text-base leading-relaxed text-stone-200">
            Celebrating academic excellence and achievements with custom staging, photo booths, and bespoke decoration setups.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 max-w-5xl mx-auto px-5 sm:px-6 lg:px-10">
        <div className="text-center mb-14">
          ...
          <h2 className="font-display text-3xl font-medium text-[var(--ink)] mt-2">Graduation Subthemes</h2>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <div className="group rounded-2xl border border-black/5 bg-white overflow-hidden shadow-sm hover:shadow-md transition p-3">
            ...
            <div className="p-4">
              ...
              <h3 className="font-display text-2xl font-medium text-[var(--ink)] mt-1">Graduation Stage</h3>
              <p className="mt-2 text-xs text-[var(--muted)] leading-relaxed">
                Stately presentation stage design, custom corporate backdrop structures, and elegant dynamic LED screens.
              </p>
              <span className="text-xs font-semibold text-gold-600 block mt-4">Starting at $1,800</span>
            </div>
          </div>
          ...
          <div className="group rounded-2xl border border-black/5 bg-white overflow-hidden shadow-sm hover:shadow-md transition p-3">
            <div className="relative aspect-video w-full overflow-hidden rounded-xl">
              <Image
                src="/images/themes/cartoon_wonderland.png"
                alt="Confetti Bloom Theme"
                fill
                className="object-cover"
              />
            </div>
            <div className="p-4">
              ...
              <h3 className="font-display text-2xl font-medium text-[var(--ink)] mt-1">Confetti Bloom</h3>
              <p className="mt-2 text-xs text-[var(--muted)] leading-relaxed">
                Colorful balloon arches, confetti drops, custom 3D cutouts, and interactive photo booth walls.
              </p>
      ...
      <section className="py-20 bg-stone-100/50 border-t border-black/5">
        <div className="max-w-md mx-auto px-5 bg-white border border-black/5 rounded-2xl p-6 sm:p-8 shadow-sm">
          <div className="text-center mb-6">
            <h3 className="font-display text-2xl font-medium text-[var(--ink)]">Plan Your Graduation Event</h3>
          </div>
          ...
          {isSubmitted ? (
            <div className="text-center py-6">
              ...
              <p className="text-xs text-[var(--muted)] mt-1">We will contact you shortly to plan the ceremony.</p>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full rounded-xl border border-black/8 px-4 py-2.5 text-xs focus:outline-none focus:border-gold-500 bg-stone-50"
                >
                  <option value="stage">Graduation Stage</option>
                  <option value="confetti">Confetti Bloom</option>
                </select>
              </div>
